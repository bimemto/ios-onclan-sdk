...
@interface OCSDKChatEmoticonView : OCSDKBaseView<UIScrollViewDelegate, CustomSegmentedControlDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate> {
    ...
    int totalPages;
    CustomSegmentedControl *tabControl;
}
